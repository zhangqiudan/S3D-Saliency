...
def se_block(residual, name, ratio=8):
  ...
  kernel_initializer = tf.keras.initializers.VarianceScaling#tf.contrib.layers.variance_scaling_initializer()
...
def cbam_block(input_feature, name, ratio=8):
  ...
  with tf.variable_scope(name):
    ...
    attention_feature = spatial_attention(input_feature, 'sp_at')
    #print ("CBAM Hello")
